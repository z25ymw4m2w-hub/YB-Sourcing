    ...
    <div class="section-inner">
      ...
      <div class="about-grid">
        ...
        <div class="about-right">
          ...
          <div class="about-bio">
            I built YB Sourcing because I know what it costs to make an uninformed decision in property. Before any deal reaches a client, I run the numbers — <span class="highlight">occupancy rates, nightly averages, local supply, projected cashflow, and downside scenarios.</span> That rigour is what separates smart sourcing from lucky sourcing.
            <br /><br />
